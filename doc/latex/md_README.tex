A lightweight game engine for small 2D titles, with minimal overhead.\hypertarget{md_README_autotoc_md1}{}\doxysubsection{Getting started}\label{md_README_autotoc_md1}
...
\DoxyCodeLine{  v0id::Window window;}
\DoxyCodeLine{  v0id::ResourcePath resourcePath;}
\DoxyCodeLine{  v0id::Input input;}
\DoxyCodeLine{  v0id::SceneStateMachine sceneManager;}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class }SceneLevel : \textcolor{keyword}{public} v0id::Scene}
\DoxyCodeLine{\{}
\DoxyCodeLine{\textcolor{keyword}{public}:}
\DoxyCodeLine{  SceneLevel(v0id::ResourcePath\& resourcePath);}
...
\DoxyCodeLine{  \textcolor{keywordtype}{void} draw(v0id::Window\& window) \textcolor{keyword}{override};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{private}:}
...
\DoxyCodeLine{\textcolor{preprocessor}{\#include "{}SceneLevel.hpp"{}}}
\DoxyCodeLine{}
\DoxyCodeLine{SceneLevel::SceneLevel(v0id::ResourcePath\& resourcePath)}
...
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{keywordflow}{if} (input.isKeyPressed(v0id::Input::Key::Esc))}
\DoxyCodeLine{    exit(0);}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{void}}
\DoxyCodeLine{SceneLevel::draw(v0id::Window\& window)}
\DoxyCodeLine{\{}
\DoxyCodeLine{  \textcolor{comment}{// TODO: Draw assets}}
\DoxyCodeLine{\}}

\end{DoxyCode}
\hypertarget{md_README_autotoc_md2}{}\doxysection{API}\label{md_README_autotoc_md2}
v0idengine works by creating a {\ttfamily Game} instance, which contains a {\ttfamily Window} (for rendering) and a {\ttfamily Scene\+State\+Machine} (for switching scenes). Scenes will contain your update logic, drawing logic, and assets, while {\ttfamily Game} will contain your scene management code.\hypertarget{md_README_autotoc_md3}{}\doxysubsection{Scenes}\label{md_README_autotoc_md3}
\hypertarget{md_README_autotoc_md4}{}\doxysubsubsection{Creating scenes}\label{md_README_autotoc_md4}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md5}{}\doxysubsubsection{Adding scenes}\label{md_README_autotoc_md5}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md6}{}\doxysubsubsection{Switching scenes}\label{md_README_autotoc_md6}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md7}{}\doxysubsubsection{Removing scenes}\label{md_README_autotoc_md7}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md8}{}\doxysubsection{Objects and components}\label{md_README_autotoc_md8}
Components are simple data containers. Objects are a collection of one or more of these.\hypertarget{md_README_autotoc_md9}{}\doxysubsubsection{Creating an object}\label{md_README_autotoc_md9}
{\ttfamily .hpp} 
\begin{DoxyCode}{0}
\DoxyCodeLine{...}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class }MyScene : \textcolor{keyword}{public} v0id::Scene}
\DoxyCodeLine{\{}
\DoxyCodeLine{...}
\DoxyCodeLine{}
\DoxyCodeLine{private:}
\DoxyCodeLine{  v0id::Object player;}
\DoxyCodeLine{}
\DoxyCodeLine{...}
\DoxyCodeLine{\}}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md10}{}\doxysubsubsection{Adding Components}\label{md_README_autotoc_md10}
{\ttfamily .cpp} 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}}
\DoxyCodeLine{MyScene::onCreate()}
...
\DoxyCodeLine{  \textcolor{keyword}{auto} sprite = player-\/>addComponent<v0id::component::Sprite>();}
\DoxyCodeLine{  sprite-\/>load(resourcePath.get() + \textcolor{stringliteral}{"{}player.png"{}});}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{void}}
\DoxyCodeLine{MyScene::draw(v0id::Window\& window)}
\DoxyCodeLine{\{}
